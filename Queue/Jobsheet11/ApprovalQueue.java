...
public class ApprovalQueue {
    ...
    void peek2() {
        if (size >= 2) {
            ...
            System.out.println("Not enough student data!");
        }
    }
    ...
    void enqueue(StudentApproval dt) {
        if (!isFull()) {
            if (isEmpty()) {
                front = rear = 0;
            } else {
    ...
    StudentApproval dequeue() {
        StudentApproval dt = null;
        if (!isEmpty()) {
            dt = data[front];
            size--;
            if (isEmpty()) {
    ...
    void process() {
        if (size>= 2) {
            ...
            System.out.println("Not enough student to process!");
        }
    }
